  ...
  return (
    <main className="main">
      <aside className="sidebar">
        <div className="sidebar-heading">
          ...
          <span className="sidebar-progress">
            {activeLessonPosition === -1
              ? 'Custom'
              : `${activeLessonPosition + 1}/${examples.length}`}
          </span>
        </div>
        <a
        ...
        <nav className="example-nav" aria-label="Trace example lessons">
          {exampleSections.map((section) => {
            const sectionExamples = orderedExampleEntries.filter(
                ...
                <h3>
                  ...
                  >
                    ...
                    <span className="example-group-meta">
                      ...
                      <span className="example-group-chevron" aria-hidden="true">
                        ›
                      </span>
                    </span>
                  </button>
      ...
      <div className="workspace">
        ...
        {selectedExample === null && (
          <SandboxRunOptions settings={sandboxSettings} onChange={updateSandboxSettings} />
        )}
        ...
        <div className="run-row run-row-top">
          ...
          <span className="hint">
            Run first, then interact with the output or edit the script below.
          </span>
        </div>
          ...
          result.animationFrames.length > 0 && (
            <section className="animation-section">
              ...
              <AnimationPlayer
                ...
                onTick={activeAnimation.execution?.mode === 'live' ? runAnimationTick : undefined}
                onRestart={activeAnimation.execution?.mode === 'live' ? runCode : undefined}
              />
            </section>
          )}
        ...
        {result !== null && (
          <section className="output-section">
            <div className="output-toolbar">
              ...
              {result.error === null && <span className="timing">{result.time.toFixed(2)} ms</span>}
            </div>
        ...
        <div className="run-row run-row-bottom">
          ...
          <a className="sandbox-link" href={shareHref} target="_blank" rel="noopener noreferrer">
            Open in new sandbox ↗
          </a>
