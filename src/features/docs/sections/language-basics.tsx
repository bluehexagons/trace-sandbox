export const languageBasics = [
  {
    ...
    content: (
      <div>
        ...
        <p>
          All values in Trace are 64-bit floats. The language emphasizes expressive one-liners and
          recursive patterns over traditional control flow.
        </p>
        <ul>
          <li>
            <strong>Version:</strong> Latest (post-v0.1.0)
          </li>
          <li>
        ...
        <table className="doc-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Percentage of <code>value</code> variable
              </td>
              <td>
                <code>{'value = 200; 15%'}</code> → 30
              </td>
            </tr>
            <tr>
              <td>
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <p>
          Variables default to <code>0</code> if not previously assigned.
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        ...
        <p>
          Use parentheses <code>( )</code> to group expressions.
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        <p>
          Boolean logic: <code>0</code> = false, non-zero = true. The true result is <code>1</code>.
        </p>
        <table className="doc-table">
          <thead>
            <tr>
        ...
        <pre>
          <code>
            {
              'x = 7; x > 5 ? 1 : 0    # If x > 5, returns 1, else 0\nx > 5 ? 1                 # Single-branch ternary'
            }
          </code>
        </pre>
        ...
        <table className="doc-table">
          ...
          <tbody>
            <tr>
              ...
              <td>Access argument by position</td>
            </tr>
            <tr>
              <td>
                <code>&amp;0</code>
    ...
    content: (
      <div>
        <p>
          ...
          also write the mapped variable into the current <code>TraceMemory</code>, so the next tick
          continues from the current state instead of restarting.
        </p>
        <pre>
          <code>{`[growth, seed]
population = seed;
population = growth * population * (1 - population)`}</code>
        </pre>
        <ul>
        ...
        <pre>
          <code>{`# The host adds to pulseTrigger when the button is pressed.
pulseTrigger > 0 ? () => {
  ...
  },
  {
    ...
    content: (
      <div>
        <p>
          Every lesson has a stable URL using its example id. The links in the learning path can be
          copied, opened in another tab, or used with browser back and forward navigation.
        </p>
        <pre>
          <code>{`?example=logistic-map`}</code>
        </pre>
        <p>
        ...
        <p>
          ...
          current script and arguments. Opening it prepopulates a fresh sandbox without running the
          shared code automatically.
        </p>
        <pre>
          <code>{`?code=value%20%3D%205%3B%20value%20*%202&args=10%2020`}</code>
        </pre>
        <p>
